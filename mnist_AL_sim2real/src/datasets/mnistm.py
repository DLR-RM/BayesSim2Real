"""
Copied from https://github.com/criteo-research/pytorch-ada/blob/master/adalib/ada/datasets/dataset_mnistm.py
...
class rgbMNIST(datasets.MNIST):
    ...
    def __getitem__(self, index: int):
        ...
        # doing this so that it is consistent with all other datasets
        # to return a PIL Image
        np_img = np.tile(img.numpy()[: ,: ,None], (1, 1, 3))
