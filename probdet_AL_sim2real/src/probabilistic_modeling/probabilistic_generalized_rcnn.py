...
# Project imports
from src.probabilistic_inference.inference_utils import get_dir_alphas
from src.probabilistic_modeling.modeling_utils import get_probabilistic_loss_weight, clamp_log_variance, covariance_output_to_cholesky
...
class ProbabilisticGeneralizedRCNN(GeneralizedRCNN):
    ...
    def forward(self,
        ...
        if not self.training and num_mc_dropout_runs == -1:
            ...
            output_list = self.produce_raw_output(batched_inputs, num_mcd=num_mc_dropout_runs)
            return output_list
    ...
    def produce_raw_output(self, 
        ...
        Args:
            ...
            num_mcd: number of forward passes when dropout is on;
